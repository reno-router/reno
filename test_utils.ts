import { BufReader } from "https://deno.land/std@v0.60.0/io/bufio.ts";
import {
  ServerRequest,
} from "https://deno.land/std@v0.60.0/http/server.ts";
import { StringReader } from "https://deno.land/std@v0.60.0/io/readers.ts";
import { readRequest } from "https://deno.land/std@v0.60.0/http/_io.ts";
